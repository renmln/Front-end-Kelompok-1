...
import {logout, auth} from "../../redux/actions/authActions";
                                                ...
                                                <div className="col-10">
                                                    <div className="row mb-1" style={{fontSize: "10px"}}>
                                                        ...
                                                        <div className="col-xl-6 mb-1" style={{textAlign: "right"}}>
                                                            <p className="mb-1">
                                                                20 Apr, 14:04 &ensp; <img src={alertnotif} alt="notifikasi" />
                                                            </p>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-10">
                                                    <div className="row mb-1" style={{fontSize: "10px"}}>
                                                        ...
                                                        <div className="col-xl-6 mb-1" style={{textAlign: "right"}}>
                                                            <p className="mb-1">
                                                                20 Apr, 14:04 &ensp; <img src={alertnotif} alt="notifikasi2" />
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <p className="mb-1" style={{fontSize: "14px", fontWeight: "bold"}}>
