        ...
        <div>
            ...
            <div className="container py-3">
                ...
                <div className="container py-3 d-flex buttonradius12">
                    <button className="btn btn-custom me-3 buttonradius12 " id="filtersemua">
                        <FiSearch /> Semua
                    </button>
                    <button className="btn btn-custom me-3 buttonradius12" id="filterHobi">
                        <FiSearch /> Hobi
                    </button>
                    <button className="btn btn-custom me-3 buttonradius12" id="filterKendaraan">
                        <FiSearch /> Kendaraan
                    </button>
                    <button className="btn btn-custom me-3 buttonradius12" id="filterBaju">
                        <FiSearch /> Baju
                    </button>
                    <button className="btn btn-custom me-3 buttonradius12" id="filterElektronik">
                        <FiSearch /> Elektronik
                    </button>
                    <button className="btn btn-custom me-3 buttonradius12" id="filterKesehatan">
                        <FiSearch /> Kesehatan
                    </button>
                </div>
            </div>
                                ...
                                <a href="/halamanproduk" className="text-decoration-none" style={{color: "black"}}>
                                    <div className="card " style={{border: "none"}}>
                                        <div className="d-flex justify-content-center ">
                                            <img className="card-img-top center-cropped m-1 img-fluid" src={item.image_1} style={{height: "150px", objectFit: "cover"}} alt="test" />
                                        </div>
