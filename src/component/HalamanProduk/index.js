        ...
        <Modal {...props} size="sm" aria-labelledby="contained-modal-title-vcenter" centered>
            ...
            <Modal.Body>
                ...
                <div>
                    <form>
                        <div className="mb-3">
                            <label for="harga_tawar" className="form-label">
                                Harga Tawar
                            </label>
                            <input type="text" className="form-control rounded " id="harga_tawar" placeholder="Rp 0,00" />
                        </div>
                        <button type="submit" className="btn btn-custom me-3 mb-2 " onClick={props.onHide}>
                            Kirim
                        </button>
                    </form>
                </div>
                ...
                <div className="row mx-auto mb-3">
                    ...
                    <div className="col-xl-4 col-sm-12">
                        <div className="card mt-1 p-2 rounded mb-2">
                            ...
                            <button className="btn btn-custom me-3 mb-2 " onClick="/" id="Terbitakan">
                                {" "}
                                Terbitakan
                            </button>
                            <button className="btn btn-custom me-3 mb-2 " onClick="/" id="Edit">
                                {" "}
                                Edit
                            </button>
                            <p>or</p>
                            <button className="btn btn-custom me-3 mb-2 " onClick={() => setModalShow(true)} id="Terbitakan">
                                {" "}
